...
export default function AddEventForm({ onClose, onSave }: AddEventFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      const existingEvents = JSON.parse(localStorage.getItem("karaokeEvents") || "[]")
      const newEvent = {
        ...eventData,
  ...
  const themes = ["Hits des années 80", "Spécial Noël", "Rock Legends", "Pop Français", "Disco Fever", "Karaoké Libre"]
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-purple-200">Organisez votre prochaine soirée karaoké</p>
          </div>
          {onClose && (
            <Button
              variant="outline"
        ...
        <Card className="bg-gradient-to-r from-green-500/20 to-emerald-600/20 backdrop-blur-sm border-green-500/30 mt-6">
          ...
          <CardContent>
            <div className="space-y-2 text-white">
              ...
              <p>
                <strong>Horaires:</strong> {eventData.startTime || "Non défini"} - {eventData.endTime || "Non défini"}
              </p>
              <p>
