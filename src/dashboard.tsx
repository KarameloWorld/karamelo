...
const participants = [
  {
    ...
    song: { title: "WITH ALL I AM", artist: "Hillsong", youtubeId: "zmt0YVQatQM" },
  },
  {
    id: 2,
    name: "Jean Martin",
    ...
    status: "En attente",
    avatar: "/placeholder.svg?height=32&width=32",
    song: { title: "Sweet Caroline", artist: "Neil Diamond", youtubeId: "1vhFnTjia_I" },
  },
  {
    id: 3,
    name: "Sophie Chen",
    ...
    status: "En attente",
    avatar: "/placeholder.svg?height=32&width=32",
    song: { title: "Don't Stop Me Now", artist: "Queen", youtubeId: "HgzGwKwLmgM" },
  },
  {
    id: 4,
    name: "Alex Rivera",
    ...
    status: "En attente",
    avatar: "/placeholder.svg?height=32&width=32",
    song: { title: "I Will Survive", artist: "Gloria Gaynor", youtubeId: "ARt9HV9T0w8" },
  },
  {
    id: 5,
    name: "Pierre Durant",
...
const waitingParticipants = participants.filter((p) => p.status === "En attente")
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-white">KaraoBar Dashboard</h1>
                <p className="text-purple-200">Bar Le Melody - Soirée du 15 Décembre</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
      ...
      <div className="container mx-auto px-6 py-8">
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="bg-black/20 backdrop-blur-sm border border-white/10">
            ...
            <TabsTrigger value="songs" className="data-[state=active]:bg-purple-600 data-[state=active]:text-white">
                ...
                <CardContent className="space-y-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center mt-2">
                        <Avatar className="h-6 w-6 mr-2">
                          ...
                          <AvatarFallback className="bg-pink-500 text-white text-xs">MD</AvatarFallback>
                        </Avatar>
                        <span className="text-sm text-purple-200">{currentSong.singer}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white/5 rounded-lg p-3">
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-purple-200">Vidéo karaoké YouTube</span>
                      <Badge className="bg-blue-500/20 text-blue-300 border-blue-500/30">HD Quality</Badge>
                    </div>
                  </div>
                </CardContent>
              </Card>
                  ...
                  <div className="space-y-3">
                    {waitingParticipants.length === 0 ? (
                      <div className="text-center py-4">
                        ...
                        <p className="text-purple-200 text-sm">Aucun participant en attente</p>
                        <Button
                          variant="outline"
                          size="sm"
                      ...
                      waitingParticipants.slice(0, 5).map((participant, index) => (
                        <div
                          key={participant.id}
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-xs text-blue-300">{participant.name}</p>
                          </div>
                          <div className="flex items-center space-x-2">
                            {participant.song?.youtubeId && (
                              <Button
                                ...
                                onClick={() =>
                                  window.open(`https://www.youtube.com/watch?v=${participant.song.youtubeId}`, "_blank")
                                }
                              >
                            ...
                            <Badge
                              variant="outline"
                              className={`text-xs ${
                                index === 0 ? "border-green-500/30 text-green-300" : "border-blue-500/30 text-blue-300"
                              }`}
                            >
                              {index === 0 ? "À vous !" : getEstimatedWaitTime(index + 1)}
                            </Badge>
                          </div>
                        </div>
                      ))
                ...
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-pink-500">{participants.length}</p>
                    </div>
                ...
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-blue-500">{waitingParticipants.length}</p>
                    </div>
                ...
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-green-500">{songs.length}</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-yellow-500">
                        {participants.filter((p) => p.status === "Terminé").length}
                      </p>
                    </div>
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="border-white/10">
                      <TableHead className="text-purple-200">Participant</TableHead>
                      <TableHead className="text-purple-200">Chansons</TableHead>
          ...
          <TabsContent value="songs" className="space-y-6">
            <div className="flex justify-between items-center">
              <h2 className="text-2xl font-bold text-white">Bibliothèque de chansons</h2>
              <Button
                className="bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700"
                onClick={() => {
                ...
                <Table>
                  <TableHeader>
                    <TableRow className="border-white/10">
                      ...
                      <TableHead className="text-purple-200">Popularité</TableHead>
                      <TableHead className="text-purple-200">Actions</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
                    {songs.map((song) => (
                      <TableRow key={song.id} className="border-white/10 hover:bg-white/5">
                        <TableCell className="text-white font-medium">{song.title}</TableCell>
                        <TableCell className="text-purple-200">{song.artist}</TableCell>
                        <TableCell>
                        ...
                        <TableCell>
                          <div className="flex items-center space-x-2">
                            <Progress value={song.popularity} className="w-16 h-2" />
                            <span className="text-sm text-white">{song.popularity}%</span>
                          </div>
                        </TableCell>
                        <TableCell>
                          <div className="flex space-x-2">
          ...
          <TabsContent value="events" className="space-y-6">
            <div className="flex justify-between items-center">
              <h2 className="text-2xl font-bold text-white">Gestion des soirées</h2>
              <Button
                className="bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <Card className="bg-gradient-to-br from-green-500/20 to-emerald-600/20 backdrop-blur-sm border-green-500/30">
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <CardTitle className="text-green-700">Soirée Actuelle</CardTitle>
                    <Badge className="bg-green-500/20 text-green-500 border-green-500">En cours</Badge>
                  </div>
                  <CardDescription className="text-black">15 Décembre 2024</CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card className="bg-black/20 backdrop-blur-sm border-white/10">
                <CardHeader>
                  ...
                  <CardDescription className="text-purple-200">22 Décembre 2024</CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card className="bg-black/20 backdrop-blur-sm border-white/10">
                <CardHeader>
                  ...
                  <CardDescription className="text-purple-200">31 Décembre 2024</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-2 text-white">
                    <p>
