...
import { Clock, Users, Music, Play, UserPlus, RefreshCw, Zap } from "lucide-react"
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-white">File d'attente en direct</h2>
          <p className="text-purple-200">Dernière mise à jour: {lastUpdate.toLocaleTimeString()}</p>
        </div>
      ...
      {currentParticipant ? (
        ...
        <Card className="bg-gradient-to-r from-gray-500/20 to-slate-600/20 backdrop-blur-sm border-gray-500/30">
          <CardContent className="p-6 text-center">
            ...
            <h3 className="text-white text-lg font-semibold mb-2">Aucun participant en cours</h3>
        ...
        <CardContent>
          {waitingParticipants.length === 0 ? (
            <div className="text-center py-8">
              ...
              <h3 className="text-white text-lg font-semibold mb-2">File d'attente vide</h3>
              <p className="text-purple-200 mb-4">Aucun participant en attente pour le moment</p>
              <Button
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-purple-300 text-sm">{participant.song?.artist || "Artiste inconnu"}</span>
                      </div>
                      <div className="flex items-center space-x-2 mt-1">
                        ...
                        <span className="text-purple-400 text-xs">
                          Inscrit à {new Date(participant.registeredAt).toLocaleTimeString()}
                        </span>
                      </div>
                    </div>
