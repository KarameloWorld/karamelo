  ...
  return (
    <div className="space-y-4">
      ...
      <Card className="bg-gradient-to-r from-orange-500/20 to-red-600/20 backdrop-blur-sm border-orange-500/30">
        <CardContent className="p-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="text-pink-600 font-semibold">👑 Connexion Admin</h3>
              <div className="space-y-1 text-sm">
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        <Badge className="bg-green-500/20 text-green-300 border-green-500/30 p-2 justify-center">Accès complet</Badge>
      </div>
    </div>
  )
}
