...
export default function BarLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      if (formData.email === barCredentials.email && formData.password === barCredentials.password) {
        // Connexion réussie
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <Card className="bg-gradient-to-r from-pink-500/20 to-purple-600/20 backdrop-blur-sm border-pink-500/30 mb-6">
          <CardContent className="p-4">
            <div className="text-center">
              <h3 className="text-black font-semibold mb-2">🔑 Identifiants de test</h3>
        ...
        <div className="mt-8 grid grid-cols-2 gap-4">
          ...
          <div className="bg-black/10 backdrop-blur-sm rounded-lg p-4 text-center">
            ...
            <p className="text-white text-sm font-medium">Suivi des participants</p>
          </div>
        </div>
