...
export default function ParticipantRegistration() {
  ...
  const [selectedSong, setSelectedSong] = useState<{id: number, title: string, artist: string, genre: string, youtubeId: string, difficulty: string} | null>(null)
  ...
  const filteredSongs = songs.filter((song) => {
    ...
    const matchesGenre = selectedGenre === "Tous" || song.genre === selectedGenre
  ...
  const handleSongSelection = (song: {id: number, title: string, artist: string, genre: string, youtubeId: string}) => {
  ...
  const handleFinalSubmit = () => {
    ...
    alert("Inscription réussie ! Vous êtes maintenant dans la file d'attente. 🎵")
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 p-4">
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-white mb-2">Rejoignez la soirée !</h1>
          <p className="text-purple-200">Inscrivez-vous et choisissez votre chanson</p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="text-center">
                <div className="bg-gradient-to-r from-blue-500/20 to-cyan-600/20 rounded-lg p-4">
                  ...
                  <p className="text-white font-semibold">{currentEvent.participants} participants</p>
              ...
              <div className="text-center">
                <div className="bg-gradient-to-r from-green-500/20 to-emerald-600/20 rounded-lg p-4">
                  ...
                  <p className="text-white font-semibold">{songs.length} chansons</p>
              ...
              <div className="text-center">
                <div className="bg-gradient-to-r from-yellow-500/20 to-orange-600/20 rounded-lg p-4">
                  ...
                  <p className="text-white font-semibold">{currentEvent.nextUp} en attente</p>
        ...
        {step === 1 && (
          <Card className="bg-black/20 backdrop-blur-sm border-white/10 max-w-md mx-auto">
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-purple-200">Remplissez vos informations pour participer</CardDescription>
            </CardHeader>
            <CardContent>
            ...
            <Card className="bg-black/20 backdrop-blur-sm border-white/10">
              <CardHeader className="text-center">
                ...
                <CardDescription className="text-purple-200">
                  Bonjour {participant.name} ! Sélectionnez la chanson que vous souhaitez interpréter
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="bg-white/5 rounded-lg p-3 text-center">
                      <p className="text-2xl font-bold text-white">{filteredSongs.length}</p>
                  ...
                  {filteredSongs.length === 0 && (
                    <div className="text-center py-8">
                      ...
                      <h3 className="text-white text-lg font-semibold mb-2">Aucune chanson trouvée</h3>
                      <p className="text-purple-200">Essayez de modifier vos critères de recherche.</p>
                    </div>
                  )}
                </div>
              </CardContent>
        ...
        {step === 3 && selectedSong && (
          <Card className="bg-black/20 backdrop-blur-sm border-white/10 max-w-md mx-auto">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-2xl text-white">Inscription confirmée !</CardTitle>
              <CardDescription className="text-purple-200">Vous êtes maintenant dans la file d'attente</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-lg p-4">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-purple-200 text-sm">Participant #{currentEvent.participants + 1}</p>
                  </div>
                </div>
              </div>

              <div className="bg-white/5 rounded-lg p-4">
                <h4 className="text-white font-semibold mb-2">Votre chanson :</h4>
              ...
              <div className="text-center space-y-2">
                ...
                <p className="text-purple-200 text-sm">Temps d'attente estimé: ~15 minutes</p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-white font-semibold">{currentEvent.currentSong}</p>
                </div>
              </div>
