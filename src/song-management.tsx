    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-white">Gestion des Chansons</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <Card className="bg-gradient-to-r from-pink-500/20 to-purple-600/20 backdrop-blur-sm border-pink-500/30">
            <CardContent className="p-4">
              <div className="text-center">
                <p className="text-2xl font-bold text-white">{songs.filter((s) => s.difficulty === "Facile").length}</p>
        ...
        <Card className="bg-black/20 backdrop-blur-sm border-white/10">
          <CardHeader>
            ...
            <CardDescription className="text-purple-200">Gérez vos chansons karaoké</CardDescription>
          </CardHeader>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="border-white/10">
                    ...
                    <TableHead className="text-purple-200">Difficulté</TableHead>
        ...
        {filteredSongs.length === 0 && (
          <Card className="bg-black/20 backdrop-blur-sm border-white/10 mt-6">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-purple-200 mb-4">Aucune chanson ne correspond à vos critères de recherche.</p>
              <Button
                onClick={handleAddSong}
                className="bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700"
              >
